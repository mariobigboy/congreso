                ...
                <div class="welcome-content h-100">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            ...
                            <div class="col-12">
                                <div class="welcome-text text-center">
                                    <h6 data-animation="fadeInUp" data-delay="200ms">Welcome | Willkommen | Benvenuto</h6>
                                    <img src="img/bg-img/sae.svg" alt="" style="width: 65%; margin: 0 auto;;">
        ...
        <div class="hotel-search-form-area" >
            <div class="container-fluid">
                <div class="hotel-search-form">
                        ...
                        <div class="row justify-content-between align-items-end" style="padding: 3%;">
                            <div class="col-md-6 ">
                                <h2>26-29 DE AGOSTO</h2>
                            
                            </div>
                            <div class="col-md-6 ">
                                <h3>HOTEL HILTON BUENOS AIRES</h3>
                            </div>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="section-heading wow fadeInUp" data-wow-delay="100ms">
                        <h6>Bienvenidos</h6>
                        <h2>XIX COSAE 2020<br>Buenos </h2>
                    </div>
                    <div class="about-us-content mb-100">
                        <h5 class="wow fadeInUp" data-wow-delay="300ms">Es nuestro deseo contar con tu presencia y que disfrutes luego de 4 años de espera...</h5>
                ...
                <div class="row align-items-center">
                    <div class="col-12 col-md-7">
                        <div class="cta-text mb-50">
                            <h2>Por inscripciones!</h2>
                            <h6>Contactos (+5411) 4961-6141 (Int 203) - FAX: (+5411) 4961-1110</h6>
                        </div>
                    </div>
                    <div class="col-12 col-md-5 text-right">
                        <a href="#" class="btn roberto-btn mb-50">Incribirse</a>
                    </div>
                </div>
            </div>
        </div>
