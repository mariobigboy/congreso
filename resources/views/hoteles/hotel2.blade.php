            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="single-room-details-area mb-50">
                        ...
                        <img src="{{asset('')}}img/bg-img/logoHotel2.jpg" alt="">

                       
                        <embed src="{{asset('')}}img/hoteles/holliday.pdf" type="application/pdf" width="100%" height="600px" />
                        </div>
                    ...
                    <div class="hotel-reservation--area mb-100">
                        <form action="#" method="post">
                            <div class="form-group mb-30">
                                ...
                                <div class="input-daterange" id="datepicker">
                                   <div style="border-radius: 10px; border: 3px solid #6aa1ed; padding: 5%">
                                    <h3 class= "text-center">From $120 + IVA</h3>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <a href="https://www.hiexpress.com/hotels/us/es/find-hotels/hotel/rates?qDest=Av%20Leandro%20N.%20Alem%20770,%20Buenos%20Aires,%20AR&qCiMy=22020&qCiD=26&qCoMy=22020&qCoD=27&qAdlt=2&qChld=0&qRms=1&qRtP=6CBARC&qIta=99618783&qSlH=BUEPT&qSlRc=TDBN&qAkamaiCC=AR&qSrt=sBR&qBrs=re.ic.in.vn.cp.vx.hi.ex.rs.cv.sb.cw.ma.ul.ki.va.ii.sp.nd.ct&qWch=0&qSmP=1&cm_mmc=hpa_AR_desktop_BUEPT_localuniversal_1_USD_2020-03-26_default_2088073182_&setPMCookies=true&glat=META_hpa_AR_desktop_BUEPT_localuniversal_1_USD_2020-03-26_default_2088073182_&qRad=30&qRdU=mi&srb_u=1&qSHBrC=EX&icdv=99618783" target="_blank" class="btn roberto-btn w-100">Check Available</a>
                            </div>
                        </form>
                    </div>
                </div>
