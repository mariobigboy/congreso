        ...
        <div class="row">
            <div class="col-12 col-lg-8">
                ...
                <div class="single-room-details-area mb-50">
                    ...
                    <img src="{{asset('')}}img/bg-img/logoHotel5.jpg" alt="">
                      
                    <embed src="{{asset('')}}img/hoteles/ce.pdf" type="application/pdf" width="100%" height="600px" />
                    </div>
                ...
                <div class="hotel-reservation--area mb-100">
                    <form action="#" method="post">
                        <div class="form-group mb-30">
                            ...
                            <div class="input-daterange" id="datepicker">
                               <div style="border-radius: 10px; border: 3px solid #6aa1ed; padding: 5%">
                                <h3 class= "text-center">From $80 + IVA</h3>
                            </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <a href="http://www.designce.com/" target="_blank" class="btn roberto-btn w-100">Check Available</a>
                        </div>
                    </form>
                </div>
            </div>
