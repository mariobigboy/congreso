                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('workshops.index') }}" class="btn btn-sm btn-primary">{{ __('Ver Workshops') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    ...
                    @else
                        <p class="text-center">Debe existir un disertante para asociarlo a un workshop, puede crear uno nuevo clickeando <a href="{{ route('disertantes.create') }}"><strong>aquí</strong></a></p>
                    @endif
                </div>
