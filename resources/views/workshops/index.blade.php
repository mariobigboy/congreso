@extends('layouts.app', ['pageSlug' => 'workshops'])
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="{{ route('workshops.create') }}" class="btn btn-sm btn-primary">{{ __('Nuevo Workshop') }}</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                            ...
                                            <td class="text-right">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            <form action="{{ route('workshops.delete', $curso->id)}}" method="get">
                                                                @csrf
                                                                

                                                                <a class="dropdown-item" href="{{ route('workshops.edit', $curso->id)}}">{{ __('Editar') }}</a>
                                                                <button type="button" class="dropdown-item" onclick="confirm('{{ __("¿Está seguro de eliminar este workshop?") }}') ? this.parentElement.submit() : ''">
                                                                            {{ __('Eliminar') }}
                                                                </button>
                                                            </form>
                                                    </div>
